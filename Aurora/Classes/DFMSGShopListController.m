...
#import "DFMSGShopListController.h"

@interface DFMSGShopListController ()

@end

NSArray *shopNames;

@implementation DFMSGShopListController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    shopNameLabel.text = [shopNames objectAtIndex:indexPath.row];
